...
enum { NetSupported, NetWMName, NetWMState, NetWMCheck, NetActiveWindow, NetWMWindowType,
       ...
       NetCurrentDesktop, NetWMIcon, NetWMFullscreen, NetWMSkipTaskbar, NetWMHidden,
       WMProtocols, WMDelete, WMState, UTF8String, NetWMWindowTypeUtility, NetWMWindowTypeNotification, NetLast };
...
private:
    ...
    void SetupBar();
    bool DrawIcon(Client* c, int x, int y, int size);
